# Azure DevOps Services (VSTS) – Micro Focus ALM Integration
...
<div align="center"><img src="../../../.gitbook/assets/VSTS-Micro_Focus_ALM.png" alt="" width="900"></div>
...
Check out the pre-requisites for [Azure DevOps Services (VSTS)](../../connectors/azure-devops.md#prerequisites) and [Micro Focus ALM](https://github.com/OpsHubProduct/OIM-Documentation/blob/main/docs/connectors/microfocus-alm-qc.md#prerequisites) systems before you proceed with the integration.
...
<div align="center"><img src="../../../.gitbook/assets/Getting_Started_With_Application_Image_1G_a.png" alt=""></div>
...
<div align="center"><img src="../../../.gitbook/assets/VSTS_4.png" alt="" width="950"></div>

### Configure System(s)

* Once you have fulfilled all the prerequisites and are done with the above-mentioned check, configure Azure DevOps Services (VSTS) – Micro Focus ALM by following the steps given on [Azure DevOps Services (VSTS)](../../connectors/azure-devops.md#system-configuration) and [Micro Focus ALM](https://github.com/OpsHubProduct/OIM-Documentation/blob/main/docs/connectors/microfocus-alm-qc.md#system-configuration) pages respectively.

<div align="center"><img src="../../../.gitbook/assets/VSTS_5.png" alt="" width="950"></div>
...
<div align="center"><img src="../../../.gitbook/assets/VSTS_6.png" alt="" width="950"></div>
...
* In the **Add Project(s) to Sync** section, select the projects you want to synchronize between Azure DevOps Services (VSTS) and Micro Focus ALM by clicking them.\
  Example: **Demo Project3** from Azure DevOps Services (VSTS) and **Demo\_SourceProject** from Micro Focus ALM.
...
<div align="center"><img src="../../../.gitbook/assets/VSTS_7.png" alt="" width="950"></div>
...
<div align="center"><img src="../../../.gitbook/assets/VSTS_8.png" alt="" width="950"></div>
...
<div align="center"><img src="../../../.gitbook/assets/VSTS_9.png" alt="" width="950"></div>
...
<div align="center"><img src="../../../.gitbook/assets/VSTS_10.png" alt="" width="950"></div>
...
* Once you have mapped the Mandatory fields, you can now add more fields for mapping.\
  ...
  * Priority → Priority
  * Status → Status
* The Status and Priority are Look-up type fields. They are marked with ![lookup](../../../.gitbook/assets/I_9.png). Once you have mapped these fields in Azure DevOps Services (VSTS) and Micro Focus ALM, click the icon to map their values one by one.

<div align="center"><img src="../../../.gitbook/assets/VSTS_11.png" alt="" width="950"></div>
...
<div align="center"><img src="../../../.gitbook/assets/VSTS_12.png" alt="" width="950"></div>
...
<div align="center"><img src="../../../.gitbook/assets/VSTS_13.png" alt="" width="950"></div>
...
<div align="center"><img src="../../../.gitbook/assets/VSTS_14.png" alt="" width="950"></div>

* You can refer to the [previous mapping](azure-devops-services-and-micro-focus-alm-integration.md#mapping-mandatory-fields) and follow the same steps further.
* Once the mapping is created, click the **Create Mapping** to create & save this mapping as well.
* Once you save the mapping successfully, you will be re-directed to the Integration page.

<div align="center"><img src="../../../.gitbook/assets/VSTS_15.png" alt="" width="950"></div>
...
> **Note**: Queries differ for different systems. For details, refer to [Azure DevOps Services (VSTS)](../../connectors/azure-devops.md#criteria-configuration) and [Micro Focus ALM](https://github.com/OpsHubProduct/OIM-Documentation/blob/main/docs/connectors/microfocus-alm-qc.md#criteria-configuration).

* Select **In Database** from the **Select criteria storage type** drop-down list.

<div align="center"><img src="../../../.gitbook/assets/VSTS_16.png" alt="" width="950"></div>
...
<div align="center"><img src="../../../.gitbook/assets/VSTS_17.png" alt="" width="950"></div>
...
<div align="center"><img src="../../../.gitbook/assets/VSTS_18.png" alt="" width="950"></div>
...
* If you face any issue, please refer to [possible reasons and their fix](https://github.com/OpsHubProduct/OIM-Documentation/blob/main/docs/help-center/faqs/general.md).
...
> **Note**: User fields are mapped by **email id**. If emails are same in both systems, mapping is automatic. If not, update the [one-to-one XSL](https://github.com/OpsHubProduct/OIM-Documentation/blob/main/docs/integrate/mapping-configuration.md++#value-mapping-using-excel-sheet) for user fields mapping.

<div align="center"><img src="../../../.gitbook/assets/VSTS_19.png" alt="" width="950"></div>
