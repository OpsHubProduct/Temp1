...
* [MBSE SDK](docs/mbse-sdk/mbse-connector-sdk-index.md)
  ...
  * [Build Your Own Connector](docs/mbse-sdk/getting-started/mbse-sdk-connector-apis.md)
    * [Registration APIs](mbse-connector-sdk-index/mbse-sdk-connector-apis/registration-apis/README.md)
    ...
    * [Authentication APIs](mbse-connector-sdk-index/mbse-sdk-connector-apis/authentication-apis/README.md)
      * [Initialize](docs/mbse-sdk/authentication/session-initialize.md)
      * [Cleanup](docs/mbse-sdk/authentication/session-logout.md)
    * [Metadata APIs](mbse-connector-sdk-index/mbse-sdk-connector-apis/metadata-apis/README.md)
    ...
    * [Multi Element Revision APIs](mbse-connector-sdk-index/mbse-sdk-connector-apis/multi-element-revision-apis/README.md)
    ...
    * [Element APIs](mbse-connector-sdk-index/mbse-sdk-connector-apis/element-apis/README.md)
    ...
    * [Relation APIs](mbse-connector-sdk-index/mbse-sdk-connector-apis/relation-apis/README.md)
      * [Add Relation](docs/mbse-sdk/relation/create-relation.md)
      * [Delete Relation](docs/mbse-sdk/relation/delete-relation.md)
    * [Branch APIs](mbse-connector-sdk-index/mbse-sdk-connector-apis/branch-apis/README.md)
  ...
  * [OIM Configuration for MBSE](mbse-connector-sdk-index/oim-configuration-for-mbse/README.md)
...
* [Help Center](docs/help-center/help-center-index.md)
  * [FAQs](docs/help-center/faqs.md)
    * [General](docs/help-center/faqs/general-faqs.md)
      ...
      * [NullEmptyInvalid values are coming for Mandatory fields in target system from the source system. How](docs/help-center/faqs/general/nullemptyinvalid-values-are-coming-for-mandatory-fields-in-target-system-from-the-source-system-how-to-prevent-them.md)
      * [Error: Entity synchronization is failing due to error: OpsHub-012010: Processing Stopped – earlier e](docs/help-center/faqs/general/error-entity-synchronization-is-failing-due-to-error-opshub-012010-processing-stopped-earlier-event\(s\)-for-entity-have-to-be-processed-first-how-to-resolve-this-error.md)
    ...
    * [Micro Focus ALM/QC](docs/help-center/faqs/hp-faqs.md)
      * [In an integration where Micro Focus ALM/QC is the source system, a specific field in the target syst](docs/help-center/faqs/hp/field-not-updated-hp-source.md)
      ...
      * [Getting error: "The Web server is configured to not list the contents of this directory" while acces](docs/help-center/faqs/hp/getting-error-the-web-server-is-configured-to-not-list-the-contents-of-this-directory-while-accessing-the-proxy-for-micro-focus-qcalm.md)
      * [Getting error: "The requested content appears to be a script and will not be served by the static fi](docs/help-center/faqs/hp/getting-error-the-requested-content-appears-to-be-script-and-will-not-be-served-by-the-static-file-handler-while-accessing-the-proxy-for-micro-focus.md)
    * [Jira](docs/help-center/faqs/jira-faqs.md)
      ...
      * [Does Cookie-based Authentication feature for Jira work with a SiteMinder cookie/any third-party cook](docs/help-center/faqs/jira/siteminder-cookie-support.md)
    ...
    * [TFS/Azure DevOps](docs/help-center/faqs/tfs-faqs.md)
      * [How does update or delete comment functionality works in Team Foundation Server (TFS) and Azure DevO](docs/help-center/faqs/tfs/update-comment.md)
      * [Which authentication modes does OpsHub Integration Manager support for Team Foundation Server (TFS)/](docs/help-center/faqs/tfs/auth-types.md)
      * [What type of user and user permissions are required for synchronization?](docs/help-center/faqs/tfs/permission.md)
      * [Which Team Foundation Server (TFS)/Azure DevOps fields are supported by OpsHub Integration Manager f](docs/help-center/faqs/tfs/fields.md)
      * [What should be scope/permissions assigned to the Personal Access Token?](docs/help-center/faqs/tfs/pat-permission.md)
      * [How do images in comment/disscussion functionality works after synchronization by OpsHub Integration](docs/help-center/faqs/tfs/comment-inline-image.md)
      * [How to resolve processing failure for Pipeline integration when there is a Service Connection delete](docs/help-center/faqs/tfs/pipelineserviceconnectionfailure.md)
    ...
    * [ServiceNow](docs/help-center/faqs/servicenow-faqs.md)
      * [Which changes are required in case entity types are not visible in mapping/integration for ServiceNo](docs/help-center/faqs/servicenow/servicenow-entity-types-not-available.md)
      * [Which steps needs to be performed if a specific field is not read only but it is shown as read only](docs/help-center/faqs/servicenow/field-readyonly.md)
      ...
      * [Which steps needs to be performed when any update done on ServiceNow entities are not getting synchr](docs/help-center/faqs/servicenow/update-not-getting-sync.md)
    ...
    * [Installer](docs/help-center/faqs/installer-faqs.md)
      ...
      * [Is it mandatory for the database to be installed on the same server on which the application is inst](docs/help-center/faqs/installer/oim-and-database-on-same-server.md)
      * [Can the application be hosted on a third-party cloud systems such as Microsoft Azure, Amazon Web Ser](docs/help-center/faqs/installer/oim-hosted-on-third-party-cloud-systems.md)
      * [Can the OpsHub Server Service be run by Active Directory users? If yes, what are the permissions req](docs/help-center/faqs/installer/oim-service-run-by-active-directory-users.md)
      ...
      * [Why am I getting the error "Please provide the correct verification code" in registration process wh](docs/help-center/faqs/installer/verification-code-error.md)
